                ...
                <div className="sticky top-0 z-10 px-6 py-4 border-b border-white/10" style={{
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        <h2 className="text-xl font-bold text-yellow-400">{editingLink ? 'Edit Link' : 'Create Short Link'}</h2>
                        <p className="text-sm text-white/60 mt-1">Manage your branded short links</p>
                      </div>
                    </div>
                    <button
                      onClick={resetForm}
                ...
                <div className="sticky bottom-0 z-10 px-6 py-4 border-t border-white/10" style={{
                  ...
                  <div className="flex items-center justify-end space-x-3">
                    ...
                    >
                      ...
                      <span>{editingLink ? 'Update Link' : 'Create Link'}</span>
                    </button>
                  </div>
                </div>
              </div>
